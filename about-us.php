...
<head>
    ...
    <title>About Kay Pharma</title>

    <meta name="description"
        content="At KayPharma we are committed to enhancing lives through groundbreaking pharmaceutical products and services. With decades of experience and a dedication to excellence, we lead the way in healthcare innovation.">
...
<body class="body-1">
    ...
    <main>
        ...
        <div class="breadcrumb__area header__background-color breadcrumb__header-up breadcrumb-space overly overflow-hidden">
            <div class="breadcrumb__background" data-background="assets/imgs/breadcrumb/page-header-1.jpg"></div>
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="about-us-2__media">
                            <div class="about-us-2__media-image-1">
                                <img src="assets/imgs/about-us/fdd/about-us.jpg" class="img-fluid" alt="image not found">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-us-2__main-content">
                            <div class="section__title-wrapper about-us-2__content mb-60 mb-xs-50">
                                ...
                                <h2 class="section__title mb-20 title-animation">KayPharma: Holistic Health Every Day</h2>
                                <p class="mb-20-1">Our team, UNIVERSALITE'S, is our greatest strength. Together, we deliver exceptional results while creating a fun, inclusive, and rewarding workplace.</p>
                                <p class="mb-0">Welcome to Holistic Haven by KayPharma, where we prioritize your well-being every day through comprehensive health solutions and dedicated care.</p>
                            </div>
                            ...
                            <div class="about-us-2__main-content__list">
                                <div class="about-us-2__main-content__list-item">
                                    ...
                                    <div class="about-us-2__main-content__list-item-text">
                                        ...
                                        <p class="mb-0">Empowering your health with holistic, innovative solutions for a better tomorrow.</p>
                                    </div>
                                </div>
                                <div class="about-us-2__main-content__list-item">
                                    <div class="about-us-2__main-content__list-item-icon">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_9843_589)">
                                                ...
                                                <path d="M3.35693 8.34961H4.23584V9.22852H3.35693V8.34961Z" fill="#0E3311" />
                                                <path d="M4.23584 10.1074H5.11475V10.9863H4.23584V10.1074Z" fill="#0E3311" />
                                                <path d="M17.589 4.39453H18.4679V5.27344H17.589V4.39453Z" fill="#0E3311" />
                                                <path d="M17.589 2.63672H18.4679V3.51562H17.589V2.63672Z" fill="#0E3311" />
                                            </g>
                                            <defs>
                                    ...
                                    <div class="about-us-2__main-content__list-item-text">
                                        ...
                                        <p class="mb-0">Delivering advanced care with precision and reliability for optimal health outcomes.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="service-3__item mb-50">
                            <div class="service-3__item-header d-flex mb-40 mb-xs-35">
                                <div class="service-3__item-header-icon">
                                    <img class="img-fluid" src="assets/imgs/service-3/service-icon-1.png" alt="icon not found">
                                </div>
                                <h4 class="mb-0">Get Fast Reply</h4>
                            </div>

                            <p class="mb-0">Swift and responsive support to address all your pharmaceutical needs efficiently.</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="service-3__item mb-50">
                            ...
                            <p class="mb-0">A center of excellence dedicated to fostering innovative health solutions and wellness.</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="service-3__item mb-50">
                            ...
                            <p class="mb-0">Comprehensive health services tailored to enhance your well-being and meet your medical needs.</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="service-3__item mb-50">
                            ...
                            <p class="mb-0">Guiding you on a journey to optimal health with personalized and effective wellness solutions.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="wellness-expertise__content">
                            <h2 class="section__title mb-15 mb-xs-10  title-animation">Revitalize Radiance Your Wellness Expertise</h2>
                            <p class="mb-40 mb-xs-30">At KayPharma, Revitalize Radiance combines expertise and innovation to enhance your wellness journey. We are dedicated to rejuvenating your health and revealing your natural vitality with personalized solutions.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="wellness-expertise__media">
                            <img src="assets/imgs/New folder/about3.jpg" class="img-fluid" alt="image not found">
        ...
        <div class="row">
                    <div class="col-12">
                        <div class="section__title-wrapper text-center mb-60 mb-xs-40">
                            <h5 class="section__subtitle title-green mb-20 mb-xs-10 title-animation"><img src="assets/imgs/ask-quesiton/heart-2.png" alt="icon not found" class="img-fluid">Our Promise</h5>
                            <h2 class="section__title color-theme-black text-capitalize title-animation">Our Promise of Excellence</h2>
                        </div>
                    </div>
                </div>
            <div class="row mb-minus-60">
                <div class="col-xl-4 col-md-6">
                    <div class="service-2__item minas">
                        <a href="service-details.html" class="service-2__item-media">
                            <img class="img-fluid" src="assets/imgs/about-us/ab3.jpg" alt="image not found">
                        </a>

                        <div class="service-2__item-content">
                            <h4 class="mb-20 mb-xs-15 d-flex align-items-start">
                                <a href="blog-details.html">
                                    <img class="img-fluid mr-15" src="assets/imgs/service-2/service-icon-1.png" alt="icon not found">
                                    Quality Medicines</a>
                            </h4>

                            <ul>
                                <li>Providing top-quality medicines that ensure effective and reliable healthcare solutions.</li>
                            </ul>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="service-2__item">
                        <a href="service-details.html" class="service-2__item-media">
                            <img class="img-fluid" src="assets/imgs/about-us/ab2.jpg" alt="image not found">
                        </a>

                        <div class="service-2__item-content">
                            <h4 class="mb-20 mb-xs-15 d-flex align-items-start">
                                <a href="blog-details.html">
                                    <img class="img-fluid mr-15" src="assets/imgs/service-2/service-icon-2.png" alt="icon not found">
                                    Support</a>
                            </h4>

                            <ul>
                                <li>Dedicated to offering reliable support and guidance for all your pharmaceutical needs.</li>
                            </ul>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="service-2__item">
                        <a href="service-details.html" class="service-2__item-media">
                            <img class="img-fluid" src="assets/imgs/about-us/ab4.jpg" alt="image not found">
                        </a>

                        <div class="service-2__item-content">
                            <h4 class="mb-20 mb-xs-15 d-flex align-items-start">
                                <a href="blog-details.html">
                                    <img class="img-fluid mr-15" src="assets/imgs/service-2/service-icon-3.png" alt="icon not found">Growth</a>
                            </h4>
                            
                            <ul>
                                <li>Innovative solutions and continuous improvement in healthcare.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="client-testimonial__media">
                            <img class="img-fluid" src="assets/imgs/New folder/about4.jpg" alt="icon not found">
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="client-testimonial__item">
                                            <div class="client-testimonial__item-icon mb-30 mb-xs-25">
                                                <img class="img-fluid" src="assets/imgs/client-testimonial/qoute.png" alt="icon not found">
                                            </div>

                                            <p class="mb-30 mb-xs-25">Kaypharma has been a trusted partner in our medical practice. Their products are of excellent quality and consistently meet the required standards. Their timely deliveries and prompt responses to urgent needs have ensured uninterrupted patient care.</p>

                                            <div class="client-testimonial__item-author d-flex align-items-center">
                                                <div class="client-testimonial__item-author-thumb">
                                                    <img class="img-fluid" src="assets/imgs/about-us/client-2.png" alt="icon not found">
                                                </div>
                                                <div class="client-testimonial__item-author-content">
                                                    <h5>Dr. Anil Sharma</h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="client-testimonial__item">
                                            ...
                                            <p class="mb-30 mb-xs-25">Working with Kaypharma has been a smooth experience. Their team is knowledgeable, responsive, and always ready to address queries. The reliability of their supplies has greatly supported our operations.</p>

                                            <div class="client-testimonial__item-author d-flex align-items-center">
                                                <div class="client-testimonial__item-author-thumb">
                                                    <img class="img-fluid" src="assets/imgs/about-us/client-1.png" alt="icon not found">
                                                </div>
                                                <div class="client-testimonial__item-author-content">
                                                    <h5>Ms. Priya Desai</h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="client-testimonial__item">
                                            ...
                                            <p class="mb-30 mb-xs-25">We appreciate Kaypharma's commitment to quality and service. Their products are dependable, deliveries punctual, and customer support exceptional, making them a reliable partner in healthcare.</p>
